...
DRIVER_HINT_DEF(
    pantographairsourcesetmain,
    STRN("Switch pantograph 3-way valve to primary air source"))
DRIVER_HINT_DEF(
    pantographairsourcesetauxiliary,
    STRN("Switch pantograph 3-way valve to auxiliary air source"))
DRIVER_HINT_DEF(pantographcompressoron, STRN("Switch on pantograph compressor"))
DRIVER_HINT_DEF(
    pantographcompressoroff, STRN("Switch off pantograph compressor"))
...
DRIVER_HINT_DEF(
    primaryconverteroverloadreset, STRN("Reset converter overload relay"))
DRIVER_HINT_DEF(maincircuitgroundreset, STRN("Reset main circuit ground relay"))
DRIVER_HINT_DEF(
    tractionnmotoroverloadreset, STRN("Reset traction motors overload relay"))
...
DRIVER_HINT_DEF(
    mastercontrollersetseriesmode, STRN("Set master controller to series mode"))
...
DRIVER_HINT_DEF(
    mastercontrollersetzerospeed, STRN("Set master controller to neutral"))
DRIVER_HINT_DEF(
    mastercontrollersetreverserunlock,
    STRN("Set master controller to position %.0f"))
DRIVER_HINT_DEF(
    trainbrakesetpipeunlock, STRN("Set brake controller to pipe filling mode"))
...
DRIVER_HINT_DEF(
    waitpantographpressuretoolow,
    STRN("Wait for sufficient air pressure in pantograph subsystem"))
...
DRIVER_HINT_DEF(
    waitloadexchange, STRN("Wait for passenger exchange to complete"))
...
DRIVER_HINT_DEF(
    bufferscompress, STRN("Apply tractive force to compress buffers"))
