...
bool compare(
    Type_ const Left, Type_ const Right, comparison_operator const Operator) {
    switch (Operator) {
        ...
        case comparison_operator::lt_eq: {
            return Left <= Right;
        }
        case comparison_operator::gt_eq: {
            return Left >= Right;
        }
        default: {
            return false;
...
inline std::string to_string(comparison_operator const Operator) {
    switch (Operator) {
        case comparison_operator::equal: {
            return "==";
        }
...
inline comparison_pass comparison_pass_from_string(std::string const Input) {
    if (Input == "all") {
        return comparison_pass::all;
    } else if (Input == "any") {
...
inline comparison_operator comparison_operator_from_string(
