...
bool sn_utils::d_bool(std::istream &s) { return (ld_uint16(s) == 1); }

glm::dvec3 sn_utils::d_dvec3(std::istream &s) {
    return {ld_float64(s), ld_float64(s), ld_float64(s)};
}

glm::vec3 sn_utils::d_vec3(std::istream &s) {
    return {ld_float32(s), ld_float32(s), ld_float32(s)};
}

glm::vec4 sn_utils::d_vec4(std::istream &s) {
    return {ld_float32(s), ld_float32(s), ld_float32(s), ld_float32(s)};
}
...
void sn_utils::s_uint8(std::ostream &s, uint8_t v) { s.write((char *)&v, 1); }
