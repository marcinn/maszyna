...
// methods
    ...
    static void OnCommand_alerterenable( TTrain *Train, command_data const &Command );
    static void OnCommand_alerterdisable( TTrain *Train, command_data const &Command );
