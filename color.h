...
glm::vec4 const uitextorange{
    164.0f / 255.0f, 132.0f / 255.0f, 84.0f / 255.0f, 1.f};
glm::vec4 const uitextgreen{
    84.0f / 255.0f, 164.0f / 255.0f, 132.0f / 255.0f, 1.f};

inline glm::vec3 XYZtoRGB(glm::vec3 const &XYZ) {
    // M^-1 for Adobe RGB from
    // http://www.brucelindbloom.com/Eqn_RGB_XYZ_Matrix.html
    float const mi[3][3] = {2.041369f,   -0.969266f, 0.0134474f,
                            -0.5649464f, 1.8760108f, -0.1183897f,
                            -0.3446944f, 0.041556f,  1.0154096f};
    // m^-1 for sRGB:
    //    float const mi[ 3 ][ 3 ] = { 3.240479f, -0.969256f, 0.055648f,
    //    -1.53715f, 1.875991f, -0.204043f, -0.49853f, 0.041556f, 1.057311f };
...
inline glm::vec3 RGBtoHSV(glm::vec3 const &RGB) {
    glm::vec3 hsv;
...
inline glm::vec3 HSVtoRGB(glm::vec3 const &HSV) {
    glm::vec3 rgb;
