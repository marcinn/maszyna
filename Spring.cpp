...
Math3D::vector3 TSpring::ComputateForces(
    ...
    if (dist > restLen) {
        //		Hterm = (dist - spring->restLen) * spring->Ks;	// Ks
        //* (dist - rest)
        ...
        //		ScaleVector(&deltaP,1.0f / dist, &springForce);	//
        //Normalize Distance Vector 		ScaleVector(&springForce,-(Hterm +
