...
class TPrzeciwposlizg
    : public TRura  // przy napelnianiu - rura, przy poslizgu - upust

{
   ...
   public:
    ...
    inline TPrzeciwposlizg() : TRura() { Poslizg = false; }
};
...
class TNESt3 : public TBrake {
   ...
   public:
    ...
    void SetSize(
        int const size,
        std::string const
            &params);             // ustawianie dysz (rozmiaru ZR), przekladniki
