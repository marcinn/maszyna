...
bool driverkeyboard_input::init() {
    default_bindings();
    recall_bindings();
    bind();
...
void driverkeyboard_input::default_bindings() {
    m_bindingsetups = {
        ...
        {user_command::trainbrakehandleoff,
        ...
        {user_command::motoroverloadrelaythresholdtoggle,
         GLFW_KEY_F | keymodifier::control},
        ...
        {user_command::nearestcarcoupleradapterattach,
         GLFW_KEY_INSERT | keymodifier::control},
        {user_command::nearestcarcoupleradapterremove,
         GLFW_KEY_DELETE | keymodifier::control},
        {user_command::occupiedcarcouplingdisconnect,
         GLFW_KEY_DELETE | keymodifier::shift},
        ...
        {user_command::doorpermitpresetactivatenext,
         GLFW_KEY_PERIOD | keymodifier::shift | keymodifier::control},
        {user_command::doorpermitpresetactivateprevious,
         GLFW_KEY_COMMA | keymodifier::shift | keymodifier::control},
        // dooropenleft,
        // dooropenright,
        ...
        {user_command::doormodetoggle,
         GLFW_KEY_SLASH | keymodifier::shift | keymodifier::control},
        // mirrorstoggle,
        ...
        {user_command::pantographselectprevious,
         GLFW_KEY_O | keymodifier::shift},
        {user_command::pantographtoggleselected,
         GLFW_KEY_O | keymodifier::shift | keymodifier::control},
        ...
        {user_command::dashboardlighttoggle,
         GLFW_KEY_SEMICOLON | keymodifier::shift},
        {user_command::timetablelighttoggle,
         GLFW_KEY_APOSTROPHE | keymodifier::shift},
        ...
        // admin_vehiclemove,
        {user_command::vehiclemoveforwards,
         GLFW_KEY_LEFT_BRACKET | keymodifier::control},
        {user_command::vehiclemovebackwards,
         GLFW_KEY_RIGHT_BRACKET | keymodifier::control},
        {user_command::vehicleboost, GLFW_KEY_TAB | keymodifier::control},
        {user_command::debugtoggle,
         GLFW_KEY_F12 | keymodifier::control | keymodifier::shift},
