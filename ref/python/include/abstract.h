...
PyAPI_FUNC(PyObject *)
    PyObject_CallMethodObjArgs(PyObject *o, PyObject *m, ...);
...
PyAPI_FUNC(int) PyObject_AsWriteBuffer(
    PyObject *obj, void **buffer, Py_ssize_t *buffer_len);
...
PyAPI_FUNC(int) PyBuffer_ToContiguous(
    void *buf, Py_buffer *view, Py_ssize_t len, char fort);
...
PyAPI_FUNC(int) PyBuffer_FillInfo(
    Py_buffer *view, PyObject *o, void *buf, Py_ssize_t len, int readonly,
    int flags);
...
PyAPI_FUNC(PyObject *) _PyNumber_ConvertIntegralToInt(
    PyObject *integral, const char *error_format);
