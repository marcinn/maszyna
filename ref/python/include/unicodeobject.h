...
typedef struct {
    PyObject_HEAD Py_ssize_t length; /* Length of raw Unicode data in buffer */
...
PyAPI_FUNC(PyObject *) PyUnicode_FromString(const char *u /* string */
);
...
PyAPI_FUNC(Py_ssize_t) PyUnicode_GetSize(PyObject *unicode /* Unicode object */
);
...
PyAPI_FUNC(PyObject *) PyUnicode_FromObject(register PyObject *obj /* Object */
);
...
PyAPI_FUNC(PyObject *) _PyUnicode_FormatAdvanced(
    PyObject *obj, Py_UNICODE *format_spec, Py_ssize_t format_spec_len);
...
PyAPI_FUNC(PyObject *)
    _PyUnicode_AsDefaultEncodedString(PyObject *, const char *);
...
PyObject *_PyUnicode_DecodeUnicodeInternal(
    const char *string, Py_ssize_t length, const char *errors);
...
PyAPI_FUNC(int) _PyUnicode_IsLowercase(Py_UNICODE ch /* Unicode character */
);

PyAPI_FUNC(int) _PyUnicode_IsUppercase(Py_UNICODE ch /* Unicode character */
);

PyAPI_FUNC(int) _PyUnicode_IsTitlecase(Py_UNICODE ch /* Unicode character */
);

PyAPI_FUNC(int)
    _PyUnicode_IsWhitespace(const Py_UNICODE ch /* Unicode character */
    );

PyAPI_FUNC(int)
    _PyUnicode_IsLinebreak(const Py_UNICODE ch /* Unicode character */
    );

PyAPI_FUNC(Py_UNICODE)
    _PyUnicode_ToLowercase(Py_UNICODE ch /* Unicode character */
    );

PyAPI_FUNC(Py_UNICODE)
    _PyUnicode_ToUppercase(Py_UNICODE ch /* Unicode character */
    );

PyAPI_FUNC(Py_UNICODE)
    _PyUnicode_ToTitlecase(Py_UNICODE ch /* Unicode character */
    );

PyAPI_FUNC(int) _PyUnicode_ToDecimalDigit(Py_UNICODE ch /* Unicode character */
);

PyAPI_FUNC(int) _PyUnicode_ToDigit(Py_UNICODE ch /* Unicode character */
);

PyAPI_FUNC(double) _PyUnicode_ToNumeric(Py_UNICODE ch /* Unicode character */
);

PyAPI_FUNC(int) _PyUnicode_IsDecimalDigit(Py_UNICODE ch /* Unicode character */
);

PyAPI_FUNC(int) _PyUnicode_IsDigit(Py_UNICODE ch /* Unicode character */
);

PyAPI_FUNC(int) _PyUnicode_IsNumeric(Py_UNICODE ch /* Unicode character */
);

PyAPI_FUNC(int) _PyUnicode_IsAlpha(Py_UNICODE ch /* Unicode character */
);
