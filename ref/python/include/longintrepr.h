...
#if !(                                                                        \
    defined HAVE_UINT64_T && defined HAVE_UINT32_T && defined HAVE_INT64_T && \
    defined HAVE_INT32_T)
#error \
    "30-bit long digits requested, but the necessary types are not available on this platform"
#endif
